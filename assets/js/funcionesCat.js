    ...
    //WHERE SkuNo = '113631' ORDER BY b.Date_To DESC LIMIT 1
                      ...
                      //  }else{  
                        ...
                        '<td data-title="CH" style="text-align:center;"><input type="checkbox" id="catalogo_articulo_list_ch_'+r.SkuNo+'" value="'+r.SkuNo+'"></td>'+
                                    '<td class="resultInput1'+(k+1)+'"data-toggle="modal" onclick="mostrarModal('+r.SkuNo+')" >'+r.SkuNo+'</td>'+
                                    '<td class="resultInput2'+(k+1)+'" data-title="PARTNO">'+r.PartNo+'</td>'+
                                    '<td class="resultInput3'+(k+1)+'" data-title="ArtICULO">'+r.xref+'</td>'+
                                    '<td class="resultInput4'+(k+1)+'"data-title="CATEGORIA">'+r.xref_universal+'</td>'+
                                    '<td class="resultInput5'+(k+1)+'"data-title="SUB CATEGORIA">'+r.Desc+'</td>'+
                                    '<td class="numeric resultInput6'+(k+1)+'" data-title="STOCK">'+r.OnHand +' - '+r.InPick+'</td> '+
                                    '<td class="numeric resultInput7'+(k+1)+'" data-title="STOCK">'+r.qty_dts+'</td> '+
                                    '<td class="resultInput8'+(k+1)+'" data-title="FLAG">'+r.PO+'</td>'+
                                    '<td class="resultInput9'+(k+1)+'" class="numeric" data-title="OFERTA">'+r.AvgCost+'</td> '+
                                    '<td class="resultInput10'+(k+1)+'" data-title="INI+ OFERTA">'+r.LastPrice+'</td>'+
                                    '<td class="resultInput11'+(k+1)+'" data-title="FIN OFERTA">'+r.BinLoc+'</td>'+
                                    '<td class="resultInput12'+(k+1)+'" data-title="FLAG">'+r.BinLoc+'</td>'+
                                    '<td class="resultInput13'+(k+1)+'" data-title="FLAG">'+r.precio1+'</td>'+
                                    '<td class="resultInput14'+(k+1)+'" data-title="FLAG">'+r.precio22+'</td>'+
    ...
    //WHERE SkuNo = '113631' ORDER BY b.Date_To DESC LIMIT 1
                      ...
                      //  }else{  
                        ...
                        salida+= '<tr class="catalogo_articulo_fila" id="catalogo_articulo_fila_'+r.SkuNo+'" >'+
                                   '<td data-title="N" style="text-align:center;">'+(k+1)+'</td>'+
                                    '<td data-title="CH" style="text-align:center;"><input type="checkbox" id="catalogo_articulo_list_ch_'+r.SkuNo+'" value="'+r.SkuNo+'"></td>'+
                                    '<td class="resultInput1'+(k+1)+'"data-title="SKUNO" id="catalogo_articulo_list_cod">'+r.SkuNo+'</td>'+
                                    '<td class="resultInput2'+(k+1)+'" data-title="PARTNO">'+r.PartNo+'</td>'+
                                    '<td class="resultInput3'+(k+1)+'" data-title="ArtICULO">'+r.ProdDesc+'</td>'+
                                    '<td class="resultInput4'+(k+1)+'" data-title="CATEGORIA">'+r.CatDesc+'</td>'+
                                    '<td class="resultInput5'+(k+1)+'" data-title="SUB CATEGORIA">'+r.PrdDesc+'</td>'+
                                    '<td class="numeric resultInput6'+(k+1)+'" data-title="PRECIO">'+precio+'</td>'+
                                    '<td class="numeric resultInput7'+(k+1)+'" data-title="STOCK">'+r.OnHand+'</td> '+
                                    '<td class="numeric resultInput8'+(k+1)+'" data-title="STOCK">'+r.qty_dts+'</td> '+
                                    '<td class="numeric resultInput9'+(k+1)+'" data-title="OFERTA">'+oferta+'</td> '+
                                    '<td class="resultInput10'+(k+1)+'" data-title="INI+ OFERTA">'+fecha_to_oferta+'</td>'+
                                    '<td class="resultInput11'+(k+1)+'" data-title="FIN OFERTA">'+fecha_from_oferta+'</td>'+
                                    '<td class="resultInput12'+(k+1)+'" data-title="FLAG">'+flag+'</td>'+
                                    '<input type="hidden" id="catalogo_articulo_arr_'+r.SkuNo+'" value="'+catalogo_articulo_arr+'">'+
                                  '</tr>';
                        n = n +1;
                    });

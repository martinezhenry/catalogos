...
$cod_img = uniqid();
$nombre_carpeta = "portadas_temp/";
//$nombre_archivo = $nombre_carpeta.$_FILES['catalogo_portada']['name'];

$tipo_archivo = $_FILES['catalogo_portada']['type'];
$tamano_archivo = $_FILES['catalogo_portada']['size'];
$temp_archivo = $_FILES['catalogo_portada']['tmp_name'];
$nom_archivo = $_FILES['catalogo_portada']['name'];
$ext = pathinfo($nom_archivo, PATHINFO_EXTENSION);
$nombre_imagen = 'pt_'.$cod_img.'.'.$ext;

...
//                        echo $resul['order_id'].', '.$catalogo_order_id.' == '.$r_order['id'].'<br>';
                ...
                $resul_art = $obj_bdmysql->select("catalogo_reng","*,DATE_FORMAT(fe_us_in,'%d/%m/%Y') as fe_us_in_dmy","id_catalogo = '".$id_catalogo."'",$catalogo_order_art,"10",$mysqli);  // PENDIETNE QUITAR LIMIT
                //PDFS

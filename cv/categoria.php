...
<div class="main">
 ...
 $num_total_registros= $contar_cat;
   ...
   $sqlarti= mysql_query("SELECT cod_art FROM catalogo_reng where id_catalogo ='$id_ca' and cat='$id_cate'", $link1); 
	...
	?>        
                            ...
                            <div class="col_1_of_3 span_1_of_3"> 
 							<? echo'<a href="single.php?id='.$r['SkuNo'].'">' ?>
                                    ...
                                    <div class="price">
                                        <div class="cart-left">
                                            <p class="title"><? echo substr($r['ProdDesc'],0,28);?></p>
                                            <div class="price1">
...
WHERE 	(inv.Discontinued = false) AND (BillPrCol.CustID ='001') AND (Inv.SkuNo = '$codigo')");
  ...
  <span class="actual"> <? echo' <span class="actual">Bs. '. $precio.'</span>' ?></span>
    <? /*echo $r['Flag01']; echo	$r['Flag02']; echo	$r['Flag03']; echo	$r['Flag04'];  echo	$r['Flag05']; echo $r['Flag06']; echo $r['Flag07']; echo $r['Flag08'];
	echo $r['Flag09'];
	echo $r['Flag10']; */?>
    <span>
    <? 
									//  echo $fl1;
									  if ($r['Flag01']==1){ 
									    ...
									    if ($eti!=NULL){?> 
                                        <img src="images/Universal Binary.png" alt="<? echo "$eti";?>"><? 									 										}
									 }
 									 ...
 									 if ($r['Flag02']=='1'){$fl='Flag02';// echo "entro al 2do if ";
										 ...
										 if ($eti2!=NULL){?> 
                                        <img src="images/Blue Ball.png" alt="<? echo "$eti2";?>"><? 									 										}
									 }
									if ($r['Flag03']=='1'){$fl='Flag03';// echo "entro al 2do if ";
										 ...
										 if ($eti3!=NULL){?> 
                                        <img src="images/Green Ball.png" alt="<? echo "$eti3";?>"><? 									 										}
									 }
									...
									if ($r['Flag04']=='1'){$fl='Flag04';// echo "entro al 2do if ";
										 ...
										 if ($eti4!=NULL){?> 
                                        <img src="images/Grey Ball.png" alt="<? echo "$eti4";?>"><? 									 										}
									 }
									 ...
									 if ($r['Flag05']=='1'){$fl='Flag05';// echo "entro al 2do if ";
										 ...
										 if ($eti5!=NULL){?> 
                                        <img src="images/Orange Ball.png" alt="<? echo "$eti5";?>"><? 									 										}
									 }
									 ...
									 if ($r['Flag06']=='1'){$fl='Flag06';// echo "entro al 2do if ";
										 ...
										 if ($eti6!=NULL){?> 
                                        <img src="images/Purple Ball.png" alt="<? echo "$eti6";?>"><? 									 										}
									 }
									 ...
									 if ($r['Flag07']=='1'){$fl='Flag07';// echo "entro al 2do if ";
										 ...
										 if ($eti7!=NULL){?> 
                                        <img src="images/Red Ball.png" alt="<? echo "$eti7";?>"><? 									 										}
									 }
									 ...
									 if ($r['Flag08']=='1'){$fl='Flag08';// echo "entro al 2do if ";
										 ...
										 if ($eti8!=NULL){?> 
                                        <img src="images/Yellow Ball.png" alt="<? echo "$eti8";?>"><? 									 										}
									 }	
									...
									if ($r['Flag09']=='1'){$fl='Flag09';// echo "entro al 2do if ";
										 ...
										 if ($eti9!=NULL){?> 
                                        <img src="images/Brown Ball.png" alt="<? echo "$eti9";?>"><? 									 										}
									 }	
										if ($r['Flag10']=='1'){$fl='Flag10';// echo "entro al 2do if ";
										 ...
										 if ($eti10!=NULL){?> 
                                        <img src="images/Black Ball.png" alt="<? echo "$eti10";?>"><? 									 										}
									 }	
									 ?></span>
                                            </div>
                                        </div>
...
?>                       
   ...
   ?>  
   <div class="col_1_of_3 span_1_of_3"> 
                                 <? echo'<a href="single.php?id='.$r2['SkuNo'].'">' ?>
                                    <div class="inner_content clearfix">
                                        <div class="product_image">
                                            <img src="images/pic.jpg" alt=""/>					
                                        </div>
                                    ...
                                    <div class="price">
                                        <div class="cart-left">
                                        <p class="title"><? echo substr($r2['ProdDesc'],0,30);?></p>
